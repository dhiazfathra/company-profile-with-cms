...
| A database file exists (that its editor matches those credentials is proven by the run's login, not here) | `ls apps/web/payload.db`                                                                                                                 | `bun run --cwd apps/web seed`            |
